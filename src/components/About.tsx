  ...
  return (
    <section id="about" className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-display mb-12 text-center animate-fade-in">About Me</h2>
        <div className="prose prose-invert mx-auto max-w-3xl px-4">
          <p className="text-base md:text-lg leading-relaxed mb-6 animate-fade-in" style={{ animationDelay: "200ms" }}>
          ...
          <p className="text-base md:text-lg leading-relaxed mb-6 animate-fade-in" style={{ animationDelay: "400ms" }}>
          ...
          <p className="text-base md:text-lg leading-relaxed animate-fade-in" style={{ animationDelay: "600ms" }}>
